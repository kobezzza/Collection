/*! Collection v6.0.0-beta.4 | https://github.com/kobezzza/Collection/blob/master/LICENSE */
...
hight:20,critical:40};r.prototype.length=function(a,b){function e(){return d.result++}var d=v(b||{});w(a)||q(a)||(d=a||d,a=null);d.filter=[].concat(a||[]);d.result=0;e.__COLLECTION_TMP__lengthQuery=!0;var c=v(this.forEach(e,d));!0!==e.__COLLECTION_TMP__lengthQuery&&(d.result=e.__COLLECTION_TMP__lengthQuery,d.onComplete&&d.onComplete(d.result));return c!==this?c:d.result};var ga=r.prototype._stack=[];r.prototype.forEach=function(a,b){var e=this,d=v(Object.create(this.p));this.p=this.b();w(b)||q(b)?
d.filter=b:Object.assign(d,b);d.notOwn&&(d.use="for in");if(d.hasOwnProperty("priority")||d.onChunk)d.thread=!0;A[d.priority]||(A[d.priority]="normal");var c=this.data,f=d.type=D(c,d.use);if(!Boolean(c)||!R[typeof c]||{weakMap:!0,weakSet:!0}[f])throw new TypeError("Incorrect data type");var h=d.filter=[].concat(d.filter||[]);if(!h.length&&a.__COLLECTION_TMP__lengthQuery){if("array"===f)return a.__COLLECTION_TMP__lengthQuery=(d.startIndex||!1!==d.endIndex?[].slice.call(c,d.startIndex||0,!1!==d.endIndex?
d.endIndex+1:c.length):c).length,this;if({map:!0,set:!0}[f]&&!d.startIndex&&!1===d.endIndex)return a.__COLLECTION_TMP__lengthQuery=c.size,this}var l=!1,g=!1;if(d.length){l=d.c=a.__COLLECTION_TMP__length||a.length;d.a=[];for(g=0;g<h.length;g++)d.a.push(h[g].__COLLECTION_TMP__length||h[g].length);g=d.a.length?d.a:!1}var x=void 0;l&&3<l&&function(){var a=v(Object.assign({},b,{onChunk:null,onIterationEnd:null,onComplete:function(a){x.value=a}}));x=function(b){if(!x.value||b)x.value=e.length(h,a);return x.value}}();
var m=void 0;g&&3<Math.max.apply(null,g)&&function(){var a=v(Object.assign({},b,{onChunk:null,onIterationEnd:null,onComplete:function(a){m.value=a}}));m=function(b){if(!m.value||b)m.value=e.length(null,a);return m.value}}();var f=[f,l,h.length,g,d.length,d.thread,d.notOwn,d.live,d.inverseFilter,d.reverse,d.mult,d.count,d.from,d.startIndex,d.endIndex].join(),t={},y=v(J[f]||la(f,d)),u={data:c,cb:a,cbLength:x,filters:h,fLength:m,link:t,onComplete:d.onComplete,onIterationEnd:d.onIterationEnd};if(d.thread&&
(c=function(){var c=void 0,g=new Promise(function(g,f){function m(a){return a?function(b,c,d,e){try{return a(b,c,d,e)}catch(g){throw f(g),g;}}:void 0}for(var l=0;l<h.length;l++)h[l]=m(h[l]);var x=d.onComplete;u.onComplete=d.onComplete=m(function(a){x&&x(a);g(a)});u.cb=m(a);u.onIterationEnd=m(d.onIterationEnd);c=t.self=y.call(e,u,b||d);t.pause&&(t.self.pause=!0);for(var l=ga.length,n=void 0,k=1;n=ga[l-k];){if(n.thread){n.thread.children.push(c);break}k++}e.g(c,d.priority,d.onComplete,m(d.onChunk))});
g.thread=c;return{h:g}}(),"object"===typeof c))return c.h;t.self=y.call(this,u,b||d);t.pause&&(t.self.pause=!0);return this};r.prototype.filter=function(a){this.p.filter=this.p.filter.concat([].slice.call(arguments));return this};r.prototype.thread=function(a,b){q(a)&&(b=a,a=null);this.p.thread=!0;a&&(this.p.priority=a);b&&(this.p.onChunk=b);return this};r.prototype.start=function(a){this.p.startIndex=a;return this};r.prototype.end=function(a){this.p.endIndex=a;return this};r.prototype.from=function(a){this.p.from=
a;return this};r.prototype.count=function(a){this.p.count=a;return this};Object.defineProperties(r.prototype,{one:{get:function(){this.p.mult=!1;return this}},inverse:{get:function(){this.p.inverseFilter=!0;return this}},reverse:{get:function(){this.p.reverse=!0;return this}}});n.clone=function(a){return JSON.parse(JSON.stringify(a))};n.extend=function(a,b,e){var d=!1,c=!1,f=!1,h=!1,l=void 0;a&&"boolean"!==typeof a?(f=a.withProto,c=a.withAccessors&&X,d=Boolean(a.concatArray),h=a.traits||!1,l=Boolean(a.deep)):
l=a||!1;var g;g=Boolean(b)&&R[typeof b]?b:w(arguments[2])?[]:{};for(var x=arguments.length,m=1;++m<x;){var t=arguments[m];if(t)for(var y in t){if(c){var u=Object.getOwnPropertyDescriptor(t,y);if(u&&(u.set||u.get)){Object.defineProperty(g,y,{get:u.get,set:u.set});continue}}var u=g[y],k=t[y];if(g!==k&&k!==t){var p=void 0;if(l&&k&&"object"===typeof k&&((p=w(k))||ba(k))){var v=u&&"object"===typeof u,r=v&&ba(u);f&&r&&!g.hasOwnProperty(y)&&(g[y]=w(g[y])?u=g[y].slice():u=Object.create(g[y]));var q=void 0;
if(p)if(p=w(u),r=!1,q=void 0,!p&&f&&d&&(p=(q=v&&Object.getPrototypeOf(u))&&w(q)&&(r=!0)),p)if(d){g[y]=(r?q:u).concat(k);continue}else q=u;else q=[];else u&&r&&!w(u)?q=u:q={};g[y]=n.extend(a,q,k)}else void 0!==k&&(h?y in g===(-1===h)&&(g[y]=k):g[y]=k)}}}return g};Object.assign(n,{extend:n.extend,clone:n.clone});r.prototype.map=function(a,b){var e=v(b||{});q(a)||(e=a||e,a=function(a){return a});if(w(e)||q(e))e={filter:e};var d="object";!e.use&&!e.notOwn||e.initial?d=e.initial?D(e.initial):D(this.data,
...
c){f.set(c,a.apply(null,arguments))};c.__COLLECTION_TMP__length=c.length>a.length?c.length:a.length;break;case "set":case "weakSep":c=function(){f.add(a.apply(null,arguments))},c.__COLLECTION_TMP__length=a.length}e.result=f;d=v(this.forEach(c,e));return d!==this?d:e.result};F.prototype.valueOf=function(){return this.link};n.in=function(a,b){return z(b,a,{test:!0})};Object.assign(n,{in:n.in});r.prototype.in=function(a){return z(this.data,a,{test:!0})};r.prototype.get=function(a,b){var e=v(b||{});if(a instanceof
F||!q(a)&&(w(a)&&!q(a[1])||null!=a&&"object"!==typeof a)){var d=z(this.data,a);e.onComplete&&e.onComplete(d);return d}w(a)||q(a)||(e=a||e,a=null);var c=void 0;!1!==e.mult&&!1!==this.p.mult?function(){var a=e.result=[];c=function(b){return a.push(b)}}():c=function(a){return e.result=a};e.filter=[].concat(a||[]);d=v(this.forEach(c,e));return d!==this?d:e.result};r.prototype.reduce=function(a,b,e,d){function c(c){null==b?(f.result=c,b=!0):f.result=a.apply(null,[f.result].concat([].slice.call(arguments)))}
var f=v(d||{});w(e)||q(e)||(f=e||f,e=null);f.result=b;f.filter=[].concat(e||[]);c.__COLLECTION_TMP__length=a.length-1;e=v(this.forEach(c,f));return e!==this?e:f.result};r.prototype.every=function(a,b){var e=v(b||{});w(a)||q(a)||(e=a||e,a=null);e.filter=[].concat(a||[]);e.mult=!1;e.inverseFilter=!e.inverseFilter;e.result=!0;var d=v(this.forEach(function(){return e.result=!1},e));return d!==this?d:e.result};r.prototype.some=function(a,b){var e=v(b||{});w(a)||q(a)||(e=a||e,a=null);e.filter=[].concat(a||
[]);e.mult=!1;e.result=!1;var d=v(this.forEach(function(){return e.result=!0},e));return d!==this?d:e.result};r.prototype.search=function(a,b){var e=this,d=v(b||{});w(a)||q(a)||(d=a||d,a=null);var c=void 0;!1!==d.mult&&!1!==this.p.mult?function(){var a=d.result=[];C(e.data)?c=function(b){return a.push(b)}:c=function(b,c){return a.push(c)}}():(d.result=null,c=function(a,b){return d.result=I(e.data)?{value:b}:C(e.data)?{value:a}:b});d.filter=[].concat(a||[]);var f=v(this.forEach(c,d));return f!==this?
f:d.result};r.prototype.includes=function(a,b,e){var d=v(e||{});w(b)||q(b)||(d=b||d,b=null);d.filter=[Number.isNaN(a)?function(a){return Number.isNaN(a)}:function(b){return b===a}].concat(b||[]);d.mult=!1;d.result=!1;b=v(this.forEach(function(){return d.result=!0},d));return b!==this?b:d.result};r.prototype.group=function(a,b,e){var d=a||function(a){return a},c=v(e||{});w(b)||q(b)||(c=b||c,b=null);var f=q(d),h=c.result=c.useMap?new Z.Map:{};a=void 0;a=c.useMap?function(a,b){var e=f?d.apply(null,arguments):
z(a,d),m=c.saveKeys?b:a;h.has(e)?h.get(e).push(m):h.set(e,[m])}:function(a,b){var e=f?d.apply(null,arguments):z(a,d),m=c.saveKeys?b:a;h[e]?h[e].push(m):h[e]=[m]};f&&(a.__COLLECTION_TMP__length=a.length>d.length?a.length:d.length);c.filter=[].concat(b||[]);c.mult=!0;b=v(this.forEach(a,c));return b!==this?b:c.result};r.prototype.remove=function(a,b){var e=v(b||{});if(a instanceof F||!q(a)&&(w(a)&&!q(a[1])||null!=a&&"object"!==typeof a)){var d=z(this.data,a,{delete:!0});e.onComplete&&e.onComplete(d);
return d}w(a)||q(a)||(e=a||e,a=null);d=D(this.data,e.use);if({iterator:!0,generator:!0}[d])throw new TypeError("Incorrect data type");var c=!1!==e.mult&&!1!==this.p.mult,f=[],h=[].splice;c&&(e.result=f);var l=void 0;switch(d){case "map":l=function(a,b,d){d.delete(b);a={result:!d.has(b),key:b,value:a};c?f.push(a):e.result=a};break;case "set":l=function(a,b,d){d.delete(a);a={result:!d.has(a),key:null,value:a};c?f.push(a):e.result=a};break;case "array":e.reverse?l=function(a,b,d){h.call(d,b,1);a={result:d[b]!==
a,key:b,value:a};c?f.push(a):e.result=a}:function(){var a=0;l=e.live?function(b,d,t,y){h.call(t,d,1);y.i(-1);b={result:t[d]!==b,key:d+a,value:b};c?f.push(b):e.result=b;a++}:function(b,d,t,y){function u(u){if(a===u)return!1;h.call(t,d,1);y.i(-1);u={result:t[d]!==b,key:d+a,value:b};c?f.push(u):e.result=u;a++}var l=y.length();"number"===typeof l?u(l):y.wait(l).then(u)}}();break;default:l=function(a,b,d){delete d[b];a={result:!1===b in d,key:b,value:a};c?f.push(a):e.result=a}}e.filter=[].concat(a||[]);
d=v(this.forEach(l,e));return d!==this?d:e.result};r.prototype.set=function(a,b,e){var d=v(e||{}),c=this.data;if(b instanceof F||!q(b)&&(w(b)&&!q(b[1])||null!=b&&"object"!==typeof b))return b=z(c,b,{value:a,create:!1!==d.create,error:!0}),d.onComplete&&d.onComplete(b),b;w(b)||q(b)||(d=b||d,b=null);e=D(c,d.use);var f=q(a),h=!1!==d.mult&&!1!==this.p.mult,l=[];h&&(d.result=l);var g=void 0;if(f){switch(e){case "map":g=function(b,c,e){var f=a.apply(null,arguments),g=void 0===f;void 0!==f&&e.get(c)!==f&&
(e.set(c,f),g=e.get(c)===f);f={key:c,value:b,result:g};h?l.push(f):d.result=f};break;case "set":g=function(b,c,e){var f=a.apply(null,arguments),g=void 0===f;void 0===f||e.has(f)||(e.delete(b),e.add(f),g=e.has(f));f={key:null,value:b,result:g};h?l.push(f):d.result=f};break;default:g=function(b,c,e){var f=a.apply(null,arguments),g=void 0===f;void 0!==f&&e[c]!==f&&(e[c]=f,g=e[c]===f);f={key:c,value:b,result:g};h?l.push(f):d.result=f}}g.__COLLECTION_TMP__length=g.length>a.length?g.length:a.length}else switch(e){case "map":g=
function(b,c,e){var f=!1;e.get(c)!==a&&(e.set(c,a),f=e.get(c)===a);b={key:c,value:b,result:f};h?l.push(b):d.result=b};break;case "set":g=function(b,c,e){c=!1;e.has(a)||(e.delete(b),e.add(a),c=e.has(a));b={key:null,value:b,result:c};h?l.push(b):d.result=b};break;default:g=function(b,c,e){var f=!1;e[c]!==a&&(e[c]=a,f=e[c]===a);b={key:c,value:b,result:f};h?l.push(b):d.result=b}}var k=d.onIterationEnd;d.filter=[].concat(b||[]);d.onIterationEnd=function(b){d.result&&d.result.length||!("key"in d)||(null==
d.key&&w(c)&&(d.key=c.length),z(c,d.key,{value:f?a(void 0,void 0,c,b):a,create:!1!==d.create}));k&&k(b)};b=v(this.forEach(g,d));return b!==this?b:d.result};var Oa=[[0,40],[41,160],[161,500],[501,2E3]];r.prototype._priority=A;var G={},H={},L;for(L in A){if(!A.hasOwnProperty(L))break;G[L]=0;H[L]=[]}var M=0;r.prototype.g=function(a,b,e,d){function c(){n(Na()).forEach(function(a,b){var c=H[b];n(a).forEach(function(a,b,d){var f=c[a];if(f.next().done){if(c.splice(a,1),n(d).forEach(function(a,b){a&&d[b]--},
{startIndex:b+1}),M--,f.onComplete&&f.onComplete!==e)f.onComplete(f.ctx.result)}else if(f.onChunk)f.onChunk(f.ctx)})});M&&setTimeout(c,40)}a.thread=!0;a.priority=b;a.destroy=function(){return n.destroy(a)};a.onComplete=e;a.onChunk=d;a.pause=!1;a.sleep=null;a.children=[];var f=a.next;Object.defineProperty(a,"next",{value:function(){null!==a.sleep&&(clearTimeout(a.sleep),a.sleep=null);return f.apply(this,arguments)}});M++;H[b].push(a);1===M&&("function"===typeof setImmediate?setImmediate(c):setTimeout(c,
0))};n.destroy=function(a){if(!a||!a.thread)return!1;var b=a.thread;clearTimeout(b.sleep);n(b.children).forEach(function(a){return n.destroy(a)});n(H[b.priority]).remove(function(a){return a===b},{mult:!1});return!0};Object.assign(n,{destroy:n.destroy});return n}"object"===typeof exports&&"undefined"!==typeof module?module.exports=N():"function"===typeof define&&define.amd?define("Collection",N):this.$C=N();
}).call(this);
