/*! Collection v6.0.0-beta.8 | https://github.com/kobezzza/Collection/blob/master/LICENSE */
...
l.get(e).push(n):l.set(e,[n])}:function(a,b){var e=f?d.apply(null,arguments):z(a,d),n=c.saveKeys?b:a;l.hasOwnProperty(e)?l[e].push(n):l[e]=[n]};f&&(a.__COLLECTION_TMP__length=a.length>d.length?a.length:d.length);a=p(this.forEach(a,c));return a!==this?a:c.result};t.prototype.remove=function(a,b){var e=b||{};if(a instanceof F||!r(a)&&(v(a)&&!r(a[1])||null!=a&&"object"!==typeof a)){var d=z(this.data,a,{delete:!0});e.onComplete&&e.onComplete(d);return d}v(a)||r(a)||(e=a||e,a=null);this.filter(e&&e.filter,
a);e=p(Object.assign(Object.create(this.p),e));d=D(this.data,e.use);if({iterator:!0,generator:!0}[d])throw new TypeError("Incorrect data type");var c=!1!==e.mult,f=[],l=[].splice;c&&(e.result=f);var g=void 0;switch(d){case "map":g=function(a,b,d){d.delete(b);a={result:!d.has(b),key:b,value:a};c?f.push(a):e.result=a};break;case "set":g=function(a,b,d){d.delete(a);a={result:!d.has(a),key:null,value:a};c?f.push(a):e.result=a};break;case "array":e.reverse?g=function(a,b,d){l.call(d,b,1);a={result:d[b]!==
a,key:b,value:a};c?f.push(a):e.result=a}:function(){var a=0;g=e.live?function(b,d,g,x){l.call(g,d,1);x.i(-1);b={result:g[d]!==b,key:d+a,value:b};c?f.push(b):e.result=b;a++}:function(b,d,g,x){function m(k){if(a===k)return!1;l.call(g,d,1);x.i(-1);k={result:g[d]!==b,key:d+a,value:b};c?f.push(k):e.result=k;a++}var k=x.length();"number"===typeof k?m(k):x.wait(k).then(m)}}();break;default:g=function(a,b,d){delete d[b];a={result:!1===b in d,key:b,value:a};c?f.push(a):e.result=a}}d=p(this.forEach(g,e));return d!==
this?d:e.result};t.prototype.set=function(a,b,e){var d=e||{},c=this.data;if(b instanceof F||!r(b)&&(v(b)&&!r(b[1])||null!=b&&"object"!==typeof b))return b=z(c,b,{value:a,create:!1!==d.create,error:!0}),d.onComplete&&d.onComplete(b),b;v(b)||r(b)||(d=b||d,b=null);this.filter(d&&d.filter,b);d=p(Object.assign(Object.create(this.p),d));b=D(c,d.use);var f=r(a),g=!1!==d.mult,k=[];g&&(d.result=k);e=void 0;if(f){switch(b){case "map":e=function(b,c,e){var f=a.apply(null,arguments),h=void 0===f;void 0!==f&&
e.get(c)!==f&&(e.set(c,f),h=e.get(c)===f);f={key:c,value:b,result:h};g?k.push(f):d.result=f};break;case "set":e=function(b,c,e){var f=a.apply(null,arguments),h=void 0===f;void 0===f||e.has(f)||(e.delete(b),e.add(f),h=e.has(f));f={key:null,value:b,result:h};g?k.push(f):d.result=f};break;default:e=function(b,c,e){var f=a.apply(null,arguments),h=void 0===f;void 0!==f&&e[c]!==f&&(e[c]=f,h=e[c]===f);f={key:c,value:b,result:h};g?k.push(f):d.result=f}}e.__COLLECTION_TMP__length=e.length>a.length?e.length:
a.length}else switch(b){case "map":e=function(b,c,e){var f=!1;e.get(c)!==a&&(e.set(c,a),f=e.get(c)===a);b={key:c,value:b,result:f};g?k.push(b):d.result=b};break;case "set":e=function(b,c,e){c=!1;e.has(a)||(e.delete(b),e.add(a),c=e.has(a));b={key:null,value:b,result:c};g?k.push(b):d.result=b};break;default:e=function(b,c,e){var f=!1;e[c]!==a&&(e[c]=a,f=e[c]===a);b={key:c,value:b,result:f};g?k.push(b):d.result=b}}var h=d.onIterationEnd;d.onIterationEnd=function(b){d.result&&d.result.length||!("key"in
d)||(null==d.key&&v(c)&&(d.key=c.length),z(c,d.key,{value:f?a(void 0,void 0,c,b):a,create:!1!==d.create}));h&&h(b)};b=p(this.forEach(e,d));return b!==this?b:d.result};var Oa=[[0,40],[41,160],[161,500],[501,2E3]];t.prototype._priority=A;var G={},H={},L;for(L in A){if(!A.hasOwnProperty(L))break;G[L]=0;H[L]=[]}var M=0;t.prototype.g=function(a,b,e,d){function c(){k(Na()).forEach(function(a,b){var c=H[b];k(a).forEach(function(a,b,d){var f=c[a];if(f.next().done){if(c.splice(a,1),k(d).forEach(function(a,
b){a&&d[b]--},{startIndex:b+1}),M--,f.onComplete&&f.onComplete!==e)f.onComplete(f.ctx.result)}else if(f.onChunk)f.onChunk(f.ctx)})});M&&setTimeout(c,40)}a.thread=!0;a.priority=b;a.destroy=function(){return k.destroy(a)};a.onComplete=e;a.onChunk=d;a.pause=!1;a.sleep=null;a.children=[];var f=a.next;Object.defineProperty(a,"next",{value:function(){null!==a.sleep&&(clearTimeout(a.sleep),a.sleep=null);return f.apply(this,arguments)}});M++;H[b].push(a);1===M&&("function"===typeof setImmediate?setImmediate(c):
setTimeout(c,0))};k.destroy=function(a){if(!a||!a.thread)return!1;var b=a.thread;clearTimeout(b.sleep);k(b.children).forEach(function(a){return k.destroy(a)});k(H[b.priority]).remove(function(a){return a===b},{mult:!1});return!0};Object.assign(k,{destroy:k.destroy});return k}"object"===typeof exports&&"undefined"!==typeof module?module.exports=N():"function"===typeof define&&define.amd?define("Collection",N):this.$C=N();
}).call(this);
