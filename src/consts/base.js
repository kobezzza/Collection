...
import { SYMBOL_SUPPORT } from './hacks';

export const NAMESPACE = '__COLLECTION_NAMESPACE__https_github_com_kobezzza_Collection';
GLOBAL[NAMESPACE] = $C;

export const
	LENGTH_REQUEST = SYMBOL_SUPPORT ? Symbol('Data length query') : '__COLLECTION_TMP__lengthQuery',
	FN_LENGTH = SYMBOL_SUPPORT ? Symbol('Function length') : '__COLLECTION_TMP__length',
